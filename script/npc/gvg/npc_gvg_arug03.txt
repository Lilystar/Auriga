...
// 守備担当
//------------------------------------------------------------
arug_cas03.gat,146,315,3	script	エスス#F3	868,{
	if('guardian1_x[0] == 0) {
...
arug_cas03.gat,65,171,0	script	第1守護石#F3	844,{
...
arug_cas03.gat,212,149,0	script	第2守護石#F3	844,{
...
arug_cas03.gat,136,158,0	script	制御装置01#F3	111,{
...
OnAgitStart:
	...
	callguardian "arug_cas03.gat",140,157," ",1905,1,"制御装置01#F3::OnKilled";
	callguardian "arug_cas03.gat",142,157," ",1905,1,"制御装置01#F3::OnKilled";
	callguardian "arug_cas03.gat",144,157," ",1905,1,"制御装置01#F3::OnKilled";
	callguardian "arug_cas03.gat",139,156," ",1905,1,"制御装置01#F3::OnKilled";
	callguardian "arug_cas03.gat",141,156," ",1905,1,"制御装置01#F3::OnKilled";
	callguardian "arug_cas03.gat",143,156," ",1905,1,"制御装置01#F3::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas03.gat","制御装置01#F3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas03.gat",139,158,144,158,0;
...
arug_cas03.gat,135,212,0	script	制御装置02#F3	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas03.gat",140,209," ",1905,1,"制御装置02#F3::OnKilled";
	callguardian "arug_cas03.gat",142,209," ",1905,1,"制御装置02#F3::OnKilled";
	callguardian "arug_cas03.gat",144,209," ",1905,1,"制御装置02#F3::OnKilled";
	callguardian "arug_cas03.gat",139,208," ",1905,1,"制御装置02#F3::OnKilled";
	callguardian "arug_cas03.gat",141,208," ",1905,1,"制御装置02#F3::OnKilled";
	callguardian "arug_cas03.gat",143,208," ",1905,1,"制御装置02#F3::OnKilled";
	set 'count,6;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas03.gat","制御装置02#F3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas03.gat",138,210,145,210,0;
...
arug_cas03.gat,134,266,0	script	制御装置03#F3	111,{
	callfunc "AgitBarricade";
	close;
OnSet:
OnAgitStart:
	...
	callguardian "arug_cas03.gat",139,262," ",1905,1,"制御装置03#F3::OnKilled";
	callguardian "arug_cas03.gat",141,262," ",1905,1,"制御装置03#F3::OnKilled";
	callguardian "arug_cas03.gat",143,262," ",1905,1,"制御装置03#F3::OnKilled";
	callguardian "arug_cas03.gat",145,262," ",1905,1,"制御装置03#F3::OnKilled";
	set 'count,4;
	end;
OnKilled:
	set 'count,'count-1;
	...
	killmonster "arug_cas03.gat","制御装置03#F3::OnKilled";
	end;
OnReset:
OnAgitEnd:
	areasetcell "arug_cas03.gat",138,263,145,263,0;
...
arug_cas03.gat,45,158,0		duplicate(#LinkFlag_F3)	ホルン#A01	111
arug_cas03.gat,226,156,0	duplicate(#LinkFlag_F3)	ホルン#A02	111
arug_cas03.gat,134,62,0		duplicate(#LinkFlag_F3)	ホルン#A03	111
arug_cas03.gat,149,62,0		duplicate(#LinkFlag_F3)	ホルン#A04	111
arug_cas03.gat,123,154,0	duplicate(#LinkFlag_F3)	ホルン#A05	111
arug_cas03.gat,160,154,0	duplicate(#LinkFlag_F3)	ホルン#A06	111
arug_cas03.gat,135,205,0	duplicate(#LinkFlag_F3)	ホルン#A07	111
arug_cas03.gat,148,205,0	duplicate(#LinkFlag_F3)	ホルン#A08	111
arug_cas03.gat,134,260,0	duplicate(#LinkFlag_F3)	ホルン#A09	111
arug_cas03.gat,149,260,0	duplicate(#LinkFlag_F3)	ホルン#A10	111
arug_cas03.gat,148,103,4	duplicate(#LinkFlag_F3)	ホルン#B11	722
arug_cas03.gat,135,103,4	duplicate(#LinkFlag_F3)	ホルン#B12	722
arug_cas03.gat,63,51,7		duplicate(#LinkFlag_F3)	ホルン#B13	722
arug_cas03.gat,214,51,1		duplicate(#LinkFlag_F3)	ホルン#B14	722

//============================================================
// カプラ職員
//------------------------------------------------------------
arug_cas03.gat,315,98,5	script	カプラ職員::AgitKafra_F3	117,{
...
// 執事
//------------------------------------------------------------
arug_cas03.gat,328,98,3	script	執事	55,{
...
aru_gld.gat,60,174,0	duplicate(#GldFlag_F3a)	ホルン#a01	722
aru_gld.gat,74,174,0	duplicate(#GldFlag_F3a)	ホルン#a02	722
...
//rachel.gat,138,126,6	duplicate(#GldFlag_F3b)	ホルン#b01	722

//============================================================
// 不思議なヒマワリ（アジトダンジョン）
//------------------------------------------------------------
arug_cas03.gat,312,154,3	script	不思議なヒマワリ#F3	977,{
